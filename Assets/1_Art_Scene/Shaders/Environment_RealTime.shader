Shader "LastLevelTest/EnvironmentRealTime"
{
    Properties
    {
        ...
        //[HideInInspector]_Rim("Rim", Range(0,1)) = 1
        //[Space(10)]

        //_OutlineColor ("Outline", Color) = (0, 0, 0, 0)
        //[HideInInspector]_Outline ("Outline", Float) = 1

        //[Space(10)]
        //[HideInInspector]_SkyReflection ("Sky Reflection", Color) = (1,1,1,1)
        //[HideInInspector]_GroundReflection ("Ground Reflection", Color) = (1,1,1,1)
        //[HideInInspector]_GIIntensity ("GI Intensity", Range(0, 5)) = 1
        
        //[Space(10)]
        //[HideInInspector]_Saturation ("Saturation", Range(0,2)) = 1
        //[HideInInspector]_Vignette ("Vignette", Float) = 1
//
    }
    SubShader
    {
